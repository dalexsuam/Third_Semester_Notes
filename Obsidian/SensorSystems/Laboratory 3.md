...
## Objective of this project is to play a song using the speaker
...
For the GPIO_EXTI8, we have that. It is important to set a priority lower than the tick timer
...
Now, for the TIM1-CH2
![[Pasted image 20251004225944.png]]

![[Pasted image 20251004224409.png]]
Prescaler 99, counter 1098 and pulse 954. To start from LA#


And to make trigger the song, with anti-bouncing...
``` C# 
//We added this variables
uint32_t tick;
uint32_t last_tick=0;
